...
> **知识底账索引**：
>
> - 显存与 KV 计算底账：[显存分析与容量规划（AI-fundamentals）](file:///d:/GeneTind/Interview/AI_BOOK/AI-fundamentals/09_inference_system/memory_calc/memory_analysis.md)
> - 位置编码数学证明：[RoPE 旋转位置编码原理（llm_interview_note）](file:///d:/GeneTind/Interview/AI_BOOK/llm_interview_note/02.大语言模型架构/3.位置编码/3.位置编码.md)
> - Block 结构与 FFN 解析：[Transformer Decoder Block 完整解析（AIInfraGuide）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块一-前置知识/transformer/3.7%20Transformer%20Decoder%20Block完整解析.md)
> - 算子与推理实现：[vLLM 核心模块深度剖析（AI-fundamentals）](file:///d:/GeneTind/Interview/AI_BOOK/AI-fundamentals/09_inference_system/vllm/module_analysis/)
...
### 本地 AI_BOOK 知识库精准映射：
- 显存模型手算：[memory_analysis.md](file:///d:/GeneTind/Interview/AI_BOOK/AI-fundamentals/09_inference_system/memory_calc/memory_analysis.md)
- 位置编码题解：[3.位置编码.md](file:///d:/GeneTind/Interview/AI_BOOK/llm_interview_note/02.大语言模型架构/3.位置编码/3.位置编码.md)
- Decoder Block 详解：[3.7 Transformer Decoder Block完整解析.md](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块一-前置知识/transformer/3.7%20Transformer%20Decoder%20Block完整解析.md)
