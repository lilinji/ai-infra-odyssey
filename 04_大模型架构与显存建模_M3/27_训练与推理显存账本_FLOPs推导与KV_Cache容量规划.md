...
> **知识底账索引**：
>
> - 显存与 KV 核心底账：[大模型训练内存与参数计算（AIInfra）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/01AICluster/04Performance/05TrainingMemory.md)
> - 推理内存与 KV Cache：[大模型推理内存与参数计算（AIInfra）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/01AICluster/04Performance/06InferenceMemory.md)
> - MFU 与算力利用率：[CODE 03: MFU 模型利用率评估（AIInfra）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/01AICluster/04Performance/CODE03MFU.md)
> - ZeRO 显存切分实现：[ZeRO 显存优化深入拆解（AIInfra）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/04Train/02ParallelAdv/Code01ZeRO.md)
...
总容量（$L=1, B=1, S=2$）：$8 \times 2 = \mathbf{16\text{ 字节}}$。
...
### 本地 AI_BOOK 知识库精准映射：
- 训练显存分析：[05TrainingMemory.md](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/01AICluster/04Performance/05TrainingMemory.md)
- 推理显存与 KV：[06InferenceMemory.md](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/01AICluster/04Performance/06InferenceMemory.md)
- MFU 与算力评估：[CODE03MFU.md](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/01AICluster/04Performance/CODE03MFU.md)
- ZeRO 原理与实战：[Code01ZeRO.md](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/04Train/02ParallelAdv/Code01ZeRO.md)
