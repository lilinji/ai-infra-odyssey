...
$$
\mathbf{K}_{\text{pool}} \in \mathbb{R}^{\text{num-blocks} \times H_{\text{kv}} \times \frac{d_{\text{head}}}{x} \times B_{\text{size}} \times x}
$$

$$
\mathbf{V}_{\text{pool}} \in \mathbb{R}^{\text{num-blocks} \times H_{\text{kv}} \times d_{\text{head}} \times B_{\text{size}}}
$$
...
$$
\mathbf{Token-Budget} = \text{max-batched-tokens} \quad (\text{如 } 2048)
$$
