...
1. **DistServe 经典论文**：
   ...
   - 详见本地知识库：[05-2 PD分离.md（AIInfra/04LongInfer）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/05Infer/04LongInfer/05-2%20PD%E5%88%86%E7%A6%BB.md)
2. **Mooncake 生产架构论文与源码**：
   - *Qin et al., "Mooncake: A KVCache-centric Disaggregated Architecture for LLM Serving", arXiv:2407.00079.*
   - 详见本地知识库：[mooncake_architecture.md（AI-fundamentals）](file:///d:/GeneTind/Interview/AI_BOOK/AI-fundamentals/09_inference_system/kv_cache/02_systems/mooncake/mooncake_architecture.md) 与 [Mooncake.md（llm-action）](file:///d:/GeneTind/Interview/AI_BOOK/llm-action/llm-inference/Mooncake.md)
...
4. **vLLM V1 KV Connector 核心规范**：
   ...
   - 详见本地知识库：[01_disaggregated_prefill_kv_transfer.md（AI-fundamentals）](file:///d:/GeneTind/Interview/AI_BOOK/AI-fundamentals/09_inference_system/kv_cache/01_concepts/pd_transfer/01_disaggregated_prefill_kv_transfer.md)
5. **分布式推理并行拓扑深度剖析**：
   - 详见本地知识库：[parallelism_strategies.md（AI-fundamentals）](file:///d:/GeneTind/Interview/AI_BOOK/AI-fundamentals/09_inference_system/parallelism/parallelism_strategies.md) 与 [Code02PDDispatch.md（AIInfra/03Dispatch）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfra/05Infer/03Dispatch/Code02PDDispatch.md)
