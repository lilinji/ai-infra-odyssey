...
> **知识底账索引**：
>
> - 数据并行底账：[4.1 数据并行详解（AIInfraGuide）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块三-分布式训练/4.1%20数据并行详解.md)
> - 集合通信原理：[2.1 集合通信原语详解（AIInfraGuide）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块三-分布式训练/2.1%20集合通信原语详解.md)
> - DDP C++ 内核实现：[数据并行 DDP 实现分析（AISystem）](file:///d:/GeneTind/Interview/AI_BOOK/AISystem/05Framework/04Parallel/02DataParallel.md)
> - NCCL 硬件互联：[NCCL 技术理论深度解析（AI-fundamentals）](file:///d:/GeneTind/Interview/AI_BOOK/AI-fundamentals/03_ai_cluster_ops/03_nccl/01_nccl_theory.md)
...
- **Double Binary Tree AllReduce**：
  ...
  - 传输步数：仅为 $2 \times \log_2(N)$ 步！在 1024 卡下只有 $2 \times 10 = \mathbf{20\text{ 步}}$！
...
### 本地 AI_BOOK 知识库精准映射：
- 数据并行详解：[4.1 数据并行详解.md](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块三-分布式训练/4.1%20数据并行详解.md)
- 集合通信原语：[2.1 集合通信原语详解.md](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块三-分布式训练/2.1%20集合通信原语详解.md)
- DDP 实现深度剖析：[02DataParallel.md](file:///d:/GeneTind/Interview/AI_BOOK/AISystem/05Framework/04Parallel/02DataParallel.md)
- NCCL 硬件互联：[01_nccl_theory.md](file:///d:/GeneTind/Interview/AI_BOOK/AI-fundamentals/03_ai_cluster_ops/03_nccl/01_nccl_theory.md)
