...
> **知识底账索引**：
>
> - 数据并行与 FSDP 详解：[4.1 数据并行详解（AIInfraGuide）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块三-分布式训练/4.1%20数据并行详解.md)
> - FSDP 实战与策略配置：[4.2 PyTorch 数据并行从原理到实战（AIInfraGuide）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块三-分布式训练/4.2%20PyTorch%20数据并行从原理到实战.md)
> - 集合通信原语量化：[2.1 集合通信原语详解（AIInfraGuide）](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块三-分布式训练/2.1%20集合通信原语详解.md)
> - ZeRO-DP 源码剖析：[完全分片数据并行 FSDP 实现（AISystem）](file:///d:/GeneTind/Interview/AI_BOOK/AISystem/05Framework/04Parallel/03ZeRODP.md)
...
- FSDP 实战指南：[4.2 PyTorch 数据并行从原理到实战.md](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块三-分布式训练/4.2%20PyTorch%20数据并行从原理到实战.md)
- 集合通信原语：[2.1 集合通信原语详解.md](file:///d:/GeneTind/Interview/AI_BOOK/AIInfraGuide/docs/guides/模块三-分布式训练/2.1%20集合通信原语详解.md)
- FSDP 源码剖析：[03ZeRODP.md](file:///d:/GeneTind/Interview/AI_BOOK/AISystem/05Framework/04Parallel/03ZeRODP.md)
