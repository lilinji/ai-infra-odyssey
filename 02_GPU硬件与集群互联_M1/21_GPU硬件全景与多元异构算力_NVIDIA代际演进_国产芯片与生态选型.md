...
3. **AI_BOOK 本地一手知识库对照出处**：
   - 🏛️ [AI_BOOK / AISystem / 02Hardware / 06Domestic / 08AscendBase.md](file:///d:/GeneTind/Interview/AI_BOOK/AISystem/02Hardware/06Domestic/08AscendBase.md)：华为昇腾计算产业全栈 AI 系统架构与硬件体系；
   - ⚡ [AI_BOOK / AISystem / 02Hardware / 06Domestic / 10AscendCube.md](file:///d:/GeneTind/Interview/AI_BOOK/AISystem/02Hardware/06Domestic/10AscendCube.md)：达芬奇架构 AI Core、Cube $16^3$ 空间分块与存储排布详解；
   - 🗺️ [AI_BOOK / AISystem / 02Hardware / 04NVIDIA / 05DeepNvlink.md](file:///d:/GeneTind/Interview/AI_BOOK/AISystem/02Hardware/04NVIDIA/05DeepNvlink.md)：NVLink 1.0 到 5.0 代际演进与物理层信号传输原理解析。
