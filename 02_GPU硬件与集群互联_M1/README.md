# 🚀 Module 01: GPU 硬件架构、数据搬运、集群通信与 Overlap 深度实战

> **主讲人**：👓 **Ringi**（大厂 AI Infrastructure 工程师）  
> **模块定位**：必修 ｜ **建议时长**：16–20h ｜ **先修要求**：[Module 00: 性能工程与系统前置](../01_性能工程与系统前置_M0/README.md)  
...
*返回前序模块：[《Module 00: 性能工程与系统前置》](../01_性能工程与系统前置_M0/README.md)*  
*进入下一模块：[《Module 02: 大模型分布式并行算法与框架》](../03_分布式训练与并行策略_M2/README.md)*
